...
namespace gaiacabinet_api.Migrations
{
    ...
    [Migration("20250816002804_InitialCreate")]
            ...
            modelBuilder.Entity("gaiacabinet_api.Models.PendingUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 8, 16, 0, 28, 3, 977, DateTimeKind.Unspecified).AddTicks(2980), new TimeSpan(0, 0, 0, 0, 0)));

                    b.Property<DateTimeOffset>("ExpiresAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 8, 26, 2, 28, 3, 975, DateTimeKind.Unspecified).AddTicks(4225), new TimeSpan(0, 2, 0, 0, 0)));
